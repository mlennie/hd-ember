...
export default Ember.Controller.extend(CurrentUserMixin, {
	...
	emailReferralMessage: function() {
		...
		var body = "body=Lorsque tu reserves un restaurant avec Happy Dining tu reçois personnellement de 10 à 30 pourcent du montant de l'addition. Si tu t'inscris avec ce lien tu recevras instantanément " + this.get('referralAmount') + " euros sur ton compte : ";
	...
	facebookShareUrl: function() {
		...
		var title = "&t=Si%20tu%20reserves%20un%20restaurant%20tu%20re%C3%A7ois%2010%25%20%C3%A0%2030%25%20du%20montant%20de%20l'addition.%20D'%C3%A9j%C3%A0%20" + this.get('referralAmount') + "%20euros%20cr%C3%A9dit%C3%A9%20grace%20%C3%A0%20ce%20lien"
	...
	twitterShareUrl: function() {
		...
		var body = "Si%20tu%20reserves%20un%20restaurant%20tu%20re%C3%A7ois%2010%25%20%C3%A0%2030%25%20du%20montant%20de%20l'addition.%20D'%C3%A9j%C3%A0%20" + this.get('referralAmount') + "%20euros%20cr%C3%A9dit%C3%A9%20grace%20%C3%A0%20ce%20lien";
